...
@UNKNOWN2:
	...
	MOVE_INT_CONSTANT 0, .LOWORD(BATTLE_EXP_SCRATCH)
	JSL UNKNOWN_C08726
	JSL UNKNOWN_C2E0E7
...
@UNKNOWN64:
	...
	BNE @UNKNOWN65
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_SURPRISE_OPENING_ATTACK
@UNKNOWN65:
	LDA #$0000
	STA $31
	BRA @UNKNOWN70
@UNKNOWN66:
	...
	CMP #STATUS_2::ASLEEP
	BNE @UNKNOWN67
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_FALLEN_ASLEEP_INDIRECT
@UNKNOWN67:
	LDX .LOWORD(CURRENT_TARGET)
	LDA a:battler::afflictions+4,X
	AND #$00FF
	BEQ @UNKNOWN68
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_STOPPED_BEING_ABLE_TO_CONCENTRATE
@UNKNOWN68:
	LDX .LOWORD(CURRENT_TARGET)
	...
	BNE @UNKNOWN69
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ACTING_A_LITTLE_STRANGE
@UNKNOWN69:
	LDA $31
	INC
	STA $31
...
@UNKNOWN97:
	...
	LDA a:.LOWORD(RAM),X
	LDX $25
	STA .LOWORD(BATTLERS_TABLE) + battler::unknown09,X
...
@UNKNOWN133:
	...
	BNE @UNKNOWN134
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ENEMYS_OPENING_ATTACK
@UNKNOWN134:
	LDA $29
	BNE @UNKNOWN135
...
@UNKNOWN141:
	...
	BCS @UNKNOWN143
@UNKNOWN142:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_RUN_SUCCESS
	STZ $17
	JMP a:.LOWORD(@UNKNOWN237)
@UNKNOWN143:
	STZ $29
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_RUN_FAILURE
@UNKNOWN144:
	STZ $23
...
@UNKNOWN148:
	...
	AND #$00FF
	BEQ @UNKNOWN149
	LDA .LOWORD(BATTLERS_TABLE)+13,X
	AND #$00FF
	BNE @UNKNOWN149
	LDA .LOWORD(BATTLERS_TABLE)+70,X
	TAX
	LDY $1B
	STY $02
	TXA
...
@UNKNOWN154:
	...
	LDX $25
	STA a:.LOWORD(RAM),X ;battler::current_action
	BRA @UNKNOWN156
@UNKNOWN155:
...
@UNKNOWN157:
	...
	INX
	INX
	LDA a:.LOWORD(RAM),X ;battler::current_action
	BEQ @UNKNOWN158
...
@UNKNOWN164:
	...
	TAX
	STX $31
	LOADPTR TEXT_BATTLE_FELT_SICK_AND_TOOK_DAMAGE, $0E
	TXA
	STA $06
	STZ $08
	MOVE_INT $06, $12
...
@UNKNOWN165:
	...
	TAX
	STX $31
	LOADPTR TEXT_BATTLE_FELT_PAIN_FROM_POISON, $0E
	TXA
	STA $06
	STZ $08
	MOVE_INT $06, $12
...
@UNKNOWN166:
	...
	TAX
	STX $31
	LOADPTR TEXT_BATTLE_FELT_DIZZY_AND_WEAK, $0E
	TXA
	STA $06
	STZ $08
	MOVE_INT $06, $12
...
@UNKNOWN167:
	...
	TAX
	STX $31
	LOADPTR TEXT_BATTLE_SNEEZED_AND_RECEIVED_DAMAGE, $0E
	TXA
	STA $06
	STZ $08
	MOVE_INT $06, $12
...
@UNKNOWN185:
	...
	BCC @UNKNOWN186
	BEQ @UNKNOWN186
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_USED_PSI
...
@UNKNOWN194:
	...
	CMP #STATUS_3::STRANGE
	BNE @UNKNOWN195
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ACTING_A_BIT_UNUSUAL
@UNKNOWN195:
	LDX .LOWORD(CURRENT_ATTACKER)
	LDA a:battler::afflictions+STATUS_GROUP::PERSISTENT_HARDHEAL,X
	AND #$00FF
	CMP #STATUS_1::MUSHROOMIZED
	BNE @UNKNOWN196
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_FEELING_FUNKY
@UNKNOWN196:
	REP #PROC_FLAGS::ACCUM8
...
@UNKNOWN203:
	...
	BNE @UNKNOWN202
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_WAS_ALREADY_GONE
	JMP a:.LOWORD(@UNKNOWN213)
@UNKNOWN204:
	LOADPTR BATTLE_ACTION_TABLE, $0A
	LDX .LOWORD(CURRENT_ATTACKER)
...
@UNKNOWN219:
	...
	BCS @UNKNOWN221
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_BODY_AGAIN_MOVED_FREELY
	LDX .LOWORD(CURRENT_ATTACKER)
	SEP #PROC_FLAGS::ACCUM8
	STZ a:battler::afflictions+STATUS_GROUP::TEMPORARY,X
	BRA @UNKNOWN221
@UNKNOWN220:
	.A16
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ABLE_TO_MOVE
	LDX .LOWORD(CURRENT_ATTACKER)
	SEP #PROC_FLAGS::ACCUM8
	STZ a:battler::afflictions+STATUS_GROUP::TEMPORARY,X
@UNKNOWN221:
	...
	AND #$00FF
	BNE @UNKNOWN222
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ABLE_TO_CONCENTRATE
@UNKNOWN222:
	LDA #.LOWORD(BATTLERS_TABLE)
	LDX #$0000
	STX $31
...
@UNKNOWN225:
	...
	STA $17
	JSL UNKNOWN_C20F9A
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_LOST_THE_BATTLE
	LDA #$0001
	STA $1D
@ALLIES_ARE_ALIVE:
	LDA #$0001
...
@ENEMIES_ARE_DEAD:
	...
	CMP #$01C0
	BCC @NOT_BOSS_BATTLE
	LOADPTR TEXT_BATTLE_YOU_WON, $0E
	MOVE_INT $06, $12
	JSL DISPLAY_TEXT_WAIT
	BRA @SKIP_NOT_BOSS_BATTLE
@NOT_BOSS_BATTLE:
	LOADPTR TEXT_BATTLE_YOU_WON_BOSS, $0E
	MOVE_INT $06, $12
	JSL DISPLAY_TEXT_WAIT
@SKIP_NOT_BOSS_BATTLE:
	...
	JSL REDIRECT_C1ACF8
	.A16
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_ENEMY_LEFT_PRESENT
@UNKNOWN230:
	LDY #.LOWORD(BATTLERS_TABLE)
	STY $31
	LDA #$0000
