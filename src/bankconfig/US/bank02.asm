...
@UNKNOWN5:
	...
	DISPLAY_BATTLE_TEXT_PTR TEXT_WAS_DIAMONDIZED
	BRA @UNKNOWN7
@UNKNOWN6:
	DISPLAY_BATTLE_TEXT_PTR TEXT_DODGED
@UNKNOWN7:
	PLD
	RTL
...
@UNKNOWN3:
	...
	STA a:.LOWORD(RAM),X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BACK_TO_NORMAL
	BRA @UNKNOWN5
@UNKNOWN4:
...
BTLACT_SNAKE: ;$C2A89D
	...
	CMP #$0000
	BEQ @UNKNOWN1
	DISPLAY_BATTLE_TEXT_PTR TEXT_GOT_POISONED
	BRA @UNKNOWN1
@UNKNOWN0:
	DISPLAY_BATTLE_TEXT_PTR TEXT_IT_DIDNT_WORK_ON_X
@UNKNOWN1:
...
@UNKNOWN3:
	...
	DISPLAY_BATTLE_TEXT_PTR TEXT_GOT_HURT_AND_COLLAPSED
	LDX $16
	CPX #$FFFF
	BNE @UNKNOWN4
