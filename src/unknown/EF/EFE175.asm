...
@UNKNOWN2:
	...
	JSL UNKNOWN_C46631
	LDX #$0080
	STX .LOWORD(SPRITE_SCREEN_X_TABLE) + (PARTY_LEADER_ENTITY_INDEX * 2)
	LDX #$0070
	STX .LOWORD(SPRITE_SCREEN_Y_TABLE) + (PARTY_LEADER_ENTITY_INDEX * 2)
	LDA .LOWORD(DEBUG_MODE_NUMBER)
	CMP #$0002
	BNE @UNKNOWN3
	LDA #$0020
	...
	STA $10
	LDY #$FFFF
	LDX #MOVEMENT_CODES::MOVEMENT_004
	LDA $1C
...
@UNKNOWN21:
	...
	STX $10
	LDY #$FFFF
	LDX #MOVEMENT_CODES::MOVEMENT_006
	LDA $1C
	JSL PARSE_C3FC49_DATA
	ASL
	TAX
...
@UNKNOWN25:
	...
	STA $10
	LDY #$FFFF
	LDX #MOVEMENT_CODES::MOVEMENT_499
	LDA #$008A
	JSL PARSE_C3FC49_DATA
	ASL
	TAX
