...
@UNKNOWN35:
	...
	LDA #9
	JSR PRINT_STRING
	LDA #.LOWORD(WINDOW_STATS_TABLE) + window_stats::width
	STA @VIRTUAL02
	STA @LOCAL07
	...
	STX @LOCAL05
	PHA
	LDA WINDOW_EXISTENCE_TABLE + WINDOW::FILE_SELECT_NAMING_CONFIRMATION_FOOD * 2
	...
	LDA @LOCAL07
	STA @VIRTUAL02
	LDA WINDOW_EXISTENCE_TABLE + WINDOW::FILE_SELECT_NAMING_CONFIRMATION_THING * 2
	LDY #.SIZEOF(window_stats)
	JSL MULT168
	CLC
	ADC @VIRTUAL02
...
@UNKNOWN59:
	...
	MOVE_INT @VIRTUAL06, UNKNOWN_7E9627
	LDA @LOCAL07
