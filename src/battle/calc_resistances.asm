...
@UNKNOWN6:
	...
	TYA
	SEP #PROC_FLAGS::ACCUM8
	STA CHAR_STRUCT+char_struct::fire_resist,X
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL00
	TAX
	LDA CHAR_STRUCT+char_struct::equipment+EQUIPMENT_SLOT::BODY,X
...
@UNKNOWN13:
	...
	TYA
	SEP #PROC_FLAGS::ACCUM8
	STA CHAR_STRUCT+char_struct::freeze_resist,X
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL00
	TAX
	LDA CHAR_STRUCT+char_struct::equipment+EQUIPMENT_SLOT::BODY,X
...
@UNKNOWN20:
	...
	TYA
	SEP #PROC_FLAGS::ACCUM8
	STA CHAR_STRUCT+char_struct::flash_resist,X
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL00
	TAX
	LDA CHAR_STRUCT+char_struct::equipment+EQUIPMENT_SLOT::BODY,X
...
@UNKNOWN27:
	...
	TYA
	SEP #PROC_FLAGS::ACCUM8
	STA CHAR_STRUCT+char_struct::paralysis_resist,X
	REP #PROC_FLAGS::ACCUM8
	LDA @LOCAL00
	TAX
...
@UNKNOWN29:
	...
	LDA @LOCAL01
	SEP #PROC_FLAGS::ACCUM8
	STA CHAR_STRUCT+char_struct::hypnosis_brainshock_resist,X
	REP #PROC_FLAGS::ACCUM8
	END_C_FUNCTION
