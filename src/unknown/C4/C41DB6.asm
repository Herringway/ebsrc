...
@UNKNOWN0:
	...
	REP #PROC_FLAGS::ACCUM8
	LDX $0A
	EOR .LOWORD(VWF_BUFFER),X
	AND $0E
	EOR .LOWORD(VWF_BUFFER),X
	STA .LOWORD(VWF_BUFFER),X
	INY
	SEP #PROC_FLAGS::ACCUM8
	LDA .LOWORD(UNKNOWN_7E3B12),Y
	XBA
	...
	REP #PROC_FLAGS::ACCUM8
	LDX $0A
	EOR .LOWORD(VWF_BUFFER) + 16,X
	AND $10
	EOR .LOWORD(VWF_BUFFER) + 16,X
	STA .LOWORD(VWF_BUFFER) + 16,X
	INY
	LDA $12
	BEQ @UNKNOWN1
	SEP #PROC_FLAGS::ACCUM8
	...
	REP #PROC_FLAGS::ACCUM8
	LDX $0A
	EOR .LOWORD(VWF_BUFFER) + 32,X
	AND $12
	EOR .LOWORD(VWF_BUFFER) + 32,X
	STA .LOWORD(VWF_BUFFER) + 32,X
@UNKNOWN1:
	INY
	INC $0A
	INC $0A
