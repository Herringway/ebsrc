...
src/bank00-2.o: src/bank00-2.asm src/config.asm $(wildcard src/bin/unknowns/C0*.bin)

src/bank01.o: src/bank01.asm src/config.asm $(wildcard src/bin/unknowns/C1*.bin)

src/bank02.o: src/bank02.asm src/config.asm $(wildcard src/bin/unknowns/C2*.bin)

src/bank03.o: src/bank03.asm src/config.asm $(wildcard src/bin/unknowns/C3*.bin)

src/bank04.o: src/bank04.asm src/config.asm src/music/packtables.asm $(wildcard src/bin/unknowns/C4*.bin)
