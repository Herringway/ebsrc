...
@UNKNOWN43:
	...
	CMP #$0003
	BNE @UNKNOWN44
	JMP @GOODS_GIVE_ALIVE_TO_ALIVE_SUCC_TEXT
@UNKNOWN44:
	CMP #$0004
	BNE @UNKNOWN45
	JMP @GOODS_GIVE_ALIVE_TO_DEAD_SUCC_TEXT
@UNKNOWN45:
	CMP #$0005
	BNE @UNKNOWN46
	JMP @GOODS_GIVE_SELF_DEAD_TEXT
@UNKNOWN46:
	CMP #$0006
	BNE @UNKNOWN47
	JMP @GOODS_GIVE_DEAD_TO_ALIVE_FAIL_TEXT
@UNKNOWN47:
	CMP #$0007
	BNE @UNKNOWN48
	JMP @GOODS_GIVE_DEAD_TO_DEAD_FAIL_TEXT
@UNKNOWN48:
	CMP #$0008
	BNE @UNKNOWN49
	JMP @GOODS_GIVE_DEAD_TO_ALIVE_SUCC_TEXT
@UNKNOWN49:
	CMP #$0009
	BNE @UNKNOWN50
	JMP @GOODS_GIVE_DEAD_TO_DEAD_SUCC_TEXT
@UNKNOWN50:
