...
@UNKNOWN6:
	...
	STA .LOWORD(ENTITY_SPRITEMAP_POINTER_LOW),Y
	LDA #.HIWORD(SPRITE_TABLE_7E467E)
	STA .LOWORD(ENTITY_SPRITEMAP_POINTER_HIGH),Y
	LDA [$0A]
	AND #$00FF
	OPTIMIZED_MULT $04, 5
	STA .LOWORD(ENTITY_UNKNOWN_2916),Y
	LDA $21
	STA .LOWORD(ENTITY_UNKNOWN_2952),Y
	TYA
	CLC
	...
	ASL
	LDY $1D
	STA .LOWORD(ENTITY_BYTE_WIDTHS),Y
	LDA [$06]
	AND #$00FF
	STA .LOWORD(ENTITY_TILE_HEIGHTS),Y
	MOVE_INT $23, $06
	SEP #PROC_FLAGS::ACCUM8
	LDY #$0008
	LDA [$06],Y
	...
	LDA $2B
	LDY $1D
	STA .LOWORD(ENTITY_TPT_ENTRY_SPRITES),Y
	LDA $14
	STA .LOWORD(ENTITY_GRAPHICS_PTR_HIGH),Y
	LDA $12
	CLC
	ADC #$0009
	STA .LOWORD(ENTITY_GRAPHICS_PTR_LOW),Y
...
@UNKNOWN7:
	...
	REP #PROC_FLAGS::ACCUM8
	AND #$00FF
	STA .LOWORD(UNKNOWN_7E3366),X
	SEP #PROC_FLAGS::ACCUM8
	LDY #$0005
	LDA [$06],Y
	REP #PROC_FLAGS::ACCUM8
	AND #$00FF
	STA .LOWORD(UNKNOWN_7E33A2),X
	SEP #PROC_FLAGS::ACCUM8
	LDY #$0006
	LDA [$06],Y
	REP #PROC_FLAGS::ACCUM8
	AND #$00FF
	STA .LOWORD(UNKNOWN_7E33DE),X
	SEP #PROC_FLAGS::ACCUM8
	LDY #$0007
	LDA [$06],Y
	REP #PROC_FLAGS::ACCUM8
	...
	STZ .LOWORD(ENTITY_OBSTACLE_FLAGS),X
	LDA $02
@UNKNOWN8:
	PLD
	RTL
