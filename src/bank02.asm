...
RECALC_CHARACTER_POSTMATH_VITALITY: ;$C21D65
	...
	CLC
	ADC .LOWORD(CHAR_STRUCT)+89,X
	STA .LOWORD(CHAR_STRUCT)+26,X
	RTL
...
RECALC_CHARACTER_POSTMATH_IQ: ;$C21D7D
	...
	CLC
	ADC .LOWORD(CHAR_STRUCT)+90,X
	STA .LOWORD(CHAR_STRUCT)+27,X
	RTL
...
DEPOSIT_INTO_ATM_UNKNOWN2:
	LDA $06
	STA .LOWORD(GAME_STATE)+64
	LDA $08
	STA .LOWORD(GAME_STATE)+66
	LDA .LOWORD(GAME_STATE)+64
	STA $06
	LDA .LOWORD(GAME_STATE)+66
	STA $08
...
UNKNOWN_C23008: ;$C23008
	...
	SEP #%00100000
	LDA a:.LOWORD(UNKNOWN_7E0000),X
	STA .LOWORD(GAME_STATE)+76
	REP #%00100000
	LDA .LOWORD(GAME_STATE)+71
	...
	STA $08
	LDA $06
	STA .LOWORD(GAME_STATE)+82
	LDA $08
	STA .LOWORD(GAME_STATE)+84
	LDA #$0000
	STA $06
	LDA #$0000
	STA $08
...
UNKNOWN_C2307B_UNKNOWN0:
	LDA .LOWORD(GAME_STATE)+82
	STA $06
	LDA .LOWORD(GAME_STATE)+84
	STA $08
	LDA $06
	STA .LOWORD(GAME_STATE)+60
	LDA $08
...
FIND_STEALABLE_ITEMS_UNKNOWN8:
	...
	LDY $12
	LDA .LOWORD(CHAR_STRUCT)+49,Y
	AND #$00FF
	CMP $02
	BEQ FIND_STEALABLE_ITEMS_UNKNOWN9
	LDA .LOWORD(CHAR_STRUCT)+50,Y
	AND #$00FF
	CMP $02
	BEQ FIND_STEALABLE_ITEMS_UNKNOWN9
	LDA .LOWORD(CHAR_STRUCT)+51,Y
	AND #$00FF
	CMP $02
	BEQ FIND_STEALABLE_ITEMS_UNKNOWN9
	LDA .LOWORD(CHAR_STRUCT)+52,Y
	AND #$00FF
	CMP $02
	BEQ FIND_STEALABLE_ITEMS_UNKNOWN9
	LDA $04
