...
BATTLE_ROUTINE_UNKNOWN68:
	LDX .LOWORD(CURRENT_TARGET)
	LDA a:.LOWORD(UNKNOWN_7E0020),X
	AND #$00FF
	CMP #$0001
	BNE BATTLE_ROUTINE_UNKNOWN69
	LOADPTR TEXT_BLOCK_EF8445, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
REVIVE_TARGET: ;$C27397
	...
	STY $18
	STA $04
	LOADPTR TEXT_BLOCK_EF6F7C, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0000
	LDX $04
	STA a:.LOWORD(UNKNOWN_7E0023),X
	LDX $04
	STA a:.LOWORD(UNKNOWN_7E0022),X
	LDX $04
	STA a:.LOWORD(UNKNOWN_7E0021),X
	LDX $04
	STA a:.LOWORD(UNKNOWN_7E0020),X
	LDX $04
...
KO_TARGET_UNKNOWN10:
	...
	STA a:.LOWORD(UNKNOWN_7E001D),X
	LDX $02
	STZ a:.LOWORD(UNKNOWN_7E0023),X
	LDX $02
	STZ a:.LOWORD(UNKNOWN_7E0022),X
	LDX $02
	STZ a:.LOWORD(UNKNOWN_7E0021),X
	LDX $02
	STZ a:.LOWORD(UNKNOWN_7E0020),X
	LDX $02
	STZ a:.LOWORD(HDMAEN_MIRROR),X
	LDX $02
...
MISS_CALC_UNKNOWN6:
	...
	LOADPTR TEXT_BLOCK_EF76D8, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA MISS_CALC_UNKNOWN8
MISS_CALC_UNKNOWN7:
	LOADPTR TEXT_BLOCK_EF76C7, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
MISS_CALC_UNKNOWN8:
	LDA #$0001
...
SMAAAASH_UNKNOWN1:
	...
	LOADPTR TEXT_BLOCK_EF7624, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA SMAAAASH_UNKNOWN3
SMAAAASH_UNKNOWN2:
	LDA #$003C
	STA .LOWORD(RED_FLASH_DURATION)
	LOADPTR TEXT_BLOCK_EF7630, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
SMAAAASH_UNKNOWN3:
	LDX .LOWORD(CURRENT_TARGET)
	LDA a:.LOWORD(UNKNOWN_7E0023),X
...
PSI_THUNDER_COMMON_UNKNOWN18:
	.A16
	LOADPTR TEXT_BLOCK_EF8837, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	LOADPTR TEXT_BLOCK_C8FAF6, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
BTLACT_SHIELD_A: ;$C29D44
	...
	LOADPTR TEXT_BLOCK_EF6FBD, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA BTLACT_SHIELD_A_UNKNOWN1
BTLACT_SHIELD_A_UNKNOWN0:
	LOADPTR TEXT_BLOCK_EF6F9A, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
BTLACT_SHIELD_B: ;$C29D81
	...
	LOADPTR TEXT_BLOCK_EF6FF4, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA BTLACT_SHIELD_B_UNKNOWN1
BTLACT_SHIELD_B_UNKNOWN0:
	LOADPTR TEXT_BLOCK_EF6FD3, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
BTLACT_TELEPORT_BOX_TELEPORT_BOX_FAILURE:
	.A16
	LOADPTR TEXT_BLOCK_C9FE9D, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA BTLACT_TELEPORT_BOX_RETURN
BTLACT_TELEPORT_BOX_TELEPORT_BOX_UNUSABLE:
	LOADPTR TEXT_BLOCK_C9FEE3, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
BTLACT_MIRROR_UNKNOWN1:
	...
	STA $14
	JSL COPY_MIRROR_DATA
	LOADPTR TEXT_BLOCK_EF6A99, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	BRA BTLACT_MIRROR_UNKNOWN3
BTLACT_MIRROR_UNKNOWN2:
	LOADPTR TEXT_BLOCK_EF6AB3, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
BTLACT_POKEY_SPEECH: ;$C2C4C0
	...
	LDA #$01DC
	JSR a:.LOWORD(UNKNOWN_C2C21F)
	LOADPTR TEXT_BLOCK_C8FC2E, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	SEP #PROC_FLAGS::ACCUM8
	STZ .LOWORD(BATTLERS_TABLE)+714
	REP #PROC_FLAGS::ACCUM8
	LDA #GIYGAS_PHASES::PHASE_3
	STA .LOWORD(GIYGAS_PHASE)
	JSL UNKNOWN_C3FDC5
	LDA #$00DC
	JSR a:.LOWORD(UNKNOWN_C2C32C)
...
BTLACT_GIYGAS_PRAYER_1: ;$C2C572
	...
	LDA #$000C
	STA .LOWORD(VERTICAL_SHAKE_HOLD_DURATION)
	LOADPTR TEXT_BLOCK_C9F86A, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
	LDA #GIYGAS_PHASES::PHASE_5
	STA .LOWORD(GIYGAS_PHASE)
	LDA #$00E5
	JSR a:.LOWORD(UNKNOWN_C2C32C)
	LDX #$0000
...
MOVEMENT_0: ;$C2FFB7
	...
	EBMOVE_SET_10F2 $00
	EBMOVE_PAUSE $05
	EBMOVE_CALLROUTINE UNKNOWN_EFE556
	EBMOVE_SHORTJUMP $FFC3
