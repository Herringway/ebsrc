...
UNKNOWN_C0A443: ;$C0A443
	...
	BNE UNKNOWN_C0A443_UNKNOWN8
	RTL
UNKNOWN_C0A443_UNKNOWN8:
...
UNKNOWN_C0A443_ENTRY4:
	...
	BEQ UNKNOWN_C0A443_UNKNOWN12
	TAX
	LDA $02
	CLC
UNKNOWN_C0A443_UNKNOWN11:
	ADC #$0004
	DEX
	BNE UNKNOWN_C0A443_UNKNOWN11
	STA $02
UNKNOWN_C0A443_UNKNOWN12:
	LDA .LOWORD(UNKNOWN_7E2892)
	BEQ UNKNOWN_C0A443_UNKNOWN13
	INC $02
	INC $02
UNKNOWN_C0A443_UNKNOWN13:
	LDA [$02]
	AND #$0002
	BNE UNKNOWN_C0A443_UNKNOWN14
	LDA .LOWORD(ENTITY_SURFACE_FLAGS),Y
	STA $06
	AND #$0008
	BEQ UNKNOWN_C0A443_UNKNOWN14
...
UNKNOWN_C0A443_UNKNOWN15:
	...
	STA a:.LOWORD(DMA_COPY_RAM_SRC)
	BRA UNKNOWN_C0A443_UNKNOWN15
UNKNOWN_C0A443_UNKNOWN16:
	RTL
