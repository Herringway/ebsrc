...
@UNKNOWN66:
	...
	LDA a:.LOWORD(RAM)+battler::afflictions+2,X
	AND #$00FF
	CMP #STATUS_2::ASLEEP
	BNE @UNKNOWN67
...
@UNKNOWN67:
	LDX .LOWORD(CURRENT_TARGET)
	LDA a:.LOWORD(RAM)+battler::afflictions+4,X
	AND #$00FF
	BEQ @UNKNOWN68
	DISPLAY_BATTLE_TEXT_PTR TEXT_BLOCK_EF8444
@UNKNOWN68:
	LDX .LOWORD(CURRENT_TARGET)
	LDA a:.LOWORD(RAM)+battler::afflictions+3,X
	AND #$00FF
...
@UNKNOWN72:
	...
	REP #PROC_FLAGS::ACCUM8
	LDA a:.LOWORD(RAM)+battler::consciousness,Y
	AND #$00FF
	BEQ @UNKNOWN73
	TYA
	CLC
	ADC #$0046
	STA $02
	LDA a:.LOWORD(RAM)+battler::speed,Y
...
@UNKNOWN137:
	LDY $2F
	LDA a:.LOWORD(RAM)+battler::afflictions,Y
	AND #$00FF
	TAX
	CPX #$0001
	BEQ @UNKNOWN139
	...
	CPX #$0003
	BEQ @UNKNOWN139
	LDA a:.LOWORD(RAM)+battler::afflictions+2,Y
	AND #$00FF
	TAX
	CPX #$0001
	BEQ @UNKNOWN139
