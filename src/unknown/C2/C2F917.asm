...
UNKNOWN_C2F917: ;$C2F917
	...
	STZ .LOWORD(NUM_BATTLERS_IN_FRONT_ROW)
	STZ .LOWORD(NUM_BATTLERS_IN_BACK_ROW)
	LDA #$0008
	STA $12
	BRA @UNKNOWN3
@UNKNOWN0:
	...
	AND #$00FF
	BEQ @UNKNOWN1
	INC .LOWORD(NUM_BATTLERS_IN_FRONT_ROW)
	BRA @UNKNOWN2
@UNKNOWN1:
	INC .LOWORD(NUM_BATTLERS_IN_BACK_ROW)
@UNKNOWN2:
	LDA $12
	INC
	STA $12
...
@UNKNOWN8:
	...
	LDX $02
	STA .LOWORD(BACK_ROW_BATTLERS),X
...
@UNKNOWN15:
	...
	SEP #PROC_FLAGS::ACCUM8
	LDX $02
	STA .LOWORD(FRONT_ROW_BATTLERS),X
	REP #PROC_FLAGS::ACCUM8
	LDA $04
	LSR
	LSR
...
@UNKNOWN16:
	LDA $02
	CMP .LOWORD(NUM_BATTLERS_IN_FRONT_ROW)
	BCCL @UNKNOWN11
	PLD
	RTL
