...
UNKNOWN_C4F07D:
	...
	COPY_TO_VRAM1 UNKNOWN_7F0000+1, VRAM::CREDITS_LAYER_2_TILEMAP, 4096, 15
	...
	COPY_TO_VRAM1 UNKNOWN_7F0700, VRAM::CREDITS_LAYER_2_TILES, 8192, 0
	LDA #0
	STA [@VIRTUAL06]
...
@UNKNOWN1:
	...
	BCC @UNKNOWN0
	REP #PROC_FLAGS::ACCUM8
	MOVE_INT_CONSTANT STAFF_TEXT, UNKNOWN_7EB4E7
	JSL UNKNOWN_C08744
	END_C_FUNCTION
