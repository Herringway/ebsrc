...
@UNKNOWN9:
	...
	ASL
	TAY
	LDA .LOWORD(UNKNOWN_7E33DE),Y
	STA $12
	LDA .LOWORD(UNKNOWN_7E1A4A),Y
	STA $10
	BRA @UNKNOWN11
@UNKNOWN10:
	LDA .LOWORD(UNKNOWN_7E3366),Y
	STA $12
	LDA .LOWORD(UNKNOWN_7E33A2),Y
	STA $10
@UNKNOWN11:
	TXA
	ASL
	STA $0E
	LDY #.LOWORD(SPRITE_ABS_Y_TABLE)
	LDA ($0E),Y
	SEC
	SBC $10
	TAY
