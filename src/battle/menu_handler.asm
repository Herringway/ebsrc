...
@UNKNOWN11:
	...
	LSR
	LSR
	CMP CHAR_STRUCT+char_struct::current_hp_target,X
	BLTEQ @UNKNOWN15
@UNKNOWN13:
	LDY $1E
	INY
...
@UNKNOWN15:
	...
	JSL AUTOLIFEUP
	SEP #PROC_FLAGS::ACCUM8
	STA UNKNOWN_7EA97D + unknown_A97D::unknown5
	REP #PROC_FLAGS::ACCUM8
	AND #$00FF
	BNEL @UNKNOWN21
@UNKNOWN17:
...
@UNKNOWN42:
	...
	SEP #PROC_FLAGS::ACCUM8
	STA UNKNOWN_7EA97D
	STZ UNKNOWN_7EA97D + unknown_A97D::unknown1
	REP #PROC_FLAGS::ACCUM8
	LDA $1A
	STA UNKNOWN_7EA97D + unknown_A97D::unknown2
	SEP #PROC_FLAGS::ACCUM8
...
@UNKNOWN95:
	...
	STA UNKNOWN_7EA97D + unknown_A97D::unknown2
	SEP #PROC_FLAGS::ACCUM8
	STZ UNKNOWN_7EA97D + unknown_A97D::unknown4
	JMP @UNKNOWN112
@UNKNOWN96:
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0001
