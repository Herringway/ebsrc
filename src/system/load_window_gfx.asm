...
LOAD_WINDOW_GFX:
	...
	JSL DECOMP
	LOADPTR UNKNOWN_7F2000, @LOCAL00
	LOADPTR UNKNOWN_7F1000, @LOCAL01
	LDA #$2A00
	JSL MEMCPY24
	LOADPTR UNKNOWN_7F3200, @LOCAL00
	LDX #1536
	...
	LOADPTR UNKNOWN_7F0100, @LOCAL01
	JSL DECOMP
	.A16
@UNKNOWN1:
	...
	LDA [@VIRTUAL06],Y
	STA @LOCAL08
	LOADPTR UNKNOWN_7F2A00, @LOCAL07
	LDA #6
	STA @LOCAL06
	LDA #0
	STA @VIRTUAL04
...
@UNKNOWN8:
	...
	BRA @UNKNOWN13
@UNKNOWN10:
	LOADPTR UNKNOWN_7F0070, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL03
	LDX #0
	BRA @UNKNOWN12
@UNKNOWN11:
...
@UNKNOWN13:
	CPY #32
	BCC @UNKNOWN10
	LOADPTR UNKNOWN_7F2C00, @LOCAL02
...
@UNKNOWN14:
	...
	CLC
	VAR_ADD_CONST_INT_ASSIGN $7F0000, @VIRTUAL0A
	LOADPTR UNKNOWN_7F0070, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL03
	LDX #0
	BRA @UNKNOWN17
