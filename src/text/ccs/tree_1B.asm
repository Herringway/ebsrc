...
@UNKNOWN12:
	JSR GET_WORKING_MEMORY
	MOVE_INT @VIRTUAL06, WRAM_SCRIPT_WORK_MEMORY
	JSR GET_ARGUMENT_MEMORY
	MOVE_INT @VIRTUAL06, WRAM_SCRIPT_ARG_MEMORY
...
@UNKNOWN13:
	.A16
	MOVE_INT WRAM_SCRIPT_WORK_MEMORY, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL00
	JSR SET_WORKING_MEMORY
	MOVE_INT WRAM_SCRIPT_ARG_MEMORY, @VIRTUAL06
	MOVE_INT @VIRTUAL06, @LOCAL00
	JSR SET_ARGUMENT_MEMORY
