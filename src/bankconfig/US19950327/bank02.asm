...
@UNKNOWN8:
	...
	SEP #PROC_FLAGS::ACCUM8
	LDA .LOWORD(GAME_STATE) + game_state::unknown7A,X
	STA .LOWORD(GAME_STATE) + game_state::unknown7A,Y
	TXY
@UNKNOWN9:
	REP #PROC_FLAGS::ACCUM8
	LDA $0E
...
@UNKNOWN1:
	SEP #PROC_FLAGS::ACCUM8
	LDA .LOWORD(GAME_STATE) + game_state::unknown7A + 1,X
	STA .LOWORD(GAME_STATE) + game_state::unknown7A,X
	INX
@UNKNOWN2:
	STX $02
...
@UNKNOWN1:
	...
	LDA $02
	JSR a:.LOWORD(SET_PP)
	LOADPTR TEXT_BATTLE_RECOVERED_PP, $0E
	LDY $16
	TYA
	STA $06
	STZ $08
...
REVIVE_TARGET: ;$C27397
	...
	STY $18
	STA $04
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_REVIVED
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0000
	LDX $04
...
BTLACT_SOLIDIFY: ;$C28CF1
	...
	CMP #$0000
	BEQ @UNKNOWN0
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_BODY_SOLIDIFED
	BRA @UNKNOWN1
@UNKNOWN0:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_IT_DIDNT_WORK_ON_X
@UNKNOWN1:
...
BTLACT_NEUTRALIZE: ;$C29051
	...
	STA a:battler::afflictions + STATUS_GROUP::SHIELD,X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_EFFECTS_OF_PSI_ARE_GONE
	PLD
	RTL
...
@UNKNOWN8:
	BMI @UNKNOWN0
@UNKNOWN9:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_POO_USED_NEW_POWER_STARSTORM
	LDA #$0000
	JSL FIX_ATTACKER_NAME
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0015
...
@REFLECT_PSI:
	.A16
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_PSYCHIC_POWER_SHIELD_DEFLECTED
	LDA #$0001
	STA .LOWORD(UNKNOWN_7EAA96)
	JSR a:.LOWORD(SWAP_ATTACKER_WITH_TARGET)
	BRA @UNKNOWN6
@ABSORB_PSI:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_PSYCHIC_POWER_SHIELD_BLOCKED
	LDA .LOWORD(CURRENT_TARGET)
	CLC
...
PSI_FREEZE_COMMON: ;$C295CF
	...
	CMP #$0000
	BEQ PSI_FREEZE_COMMON_WEAKEN_SHIELD
	LOADPTR TEXT_BATTLE_BODY_SOLIDIFED, $0E
	JSL DISPLAY_IN_BATTLE_TEXT
...
@UNKNOWN1:
	...
	STA a:.LOWORD(RAM),X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_FELT_MUCH_BETTER
	BRA @UNKNOWN5
@UNKNOWN2:
	LDA .LOWORD(CURRENT_TARGET)
	CLC
	...
	STA a:.LOWORD(RAM),X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_STOPPED_CRYING
	BRA @UNKNOWN5
@UNKNOWN3:
	LDA .LOWORD(CURRENT_TARGET)
	CLC
...
@UNKNOWN0:
	...
	STA a:.LOWORD(RAM),X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_NUMBNESS_GONE
	BRA @UNKNOWN5
@UNKNOWN1:
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0000
	STA a:.LOWORD(RAM),X
	REP #PROC_FLAGS::ACCUM8
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_BODY_RETURNED_TO_NORMAL
	BRA @UNKNOWN5
@UNKNOWN2:
	SEP #PROC_FLAGS::ACCUM8
	LDA #$00C0
...
@UNKNOWN3:
	.A16
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_REVIVE_DIDNT_WORK
	BRA @UNKNOWN5
@UNKNOWN4:
...
BTLACT_PSI_SHIELD_B: ;$C29DFB
	...
	CMP #$0000
	BEQ @UNKNOWN0
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_PSYCHIC_POWER_SHIELD_GOT_STRONGER
	BRA @UNKNOWN1
@UNKNOWN0:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_PROTECTED_BY_PSYCHIC_POWER_SHIELD
@UNKNOWN1:
	PLD
	RTL
...
@BATTLERISBELCH:
	...
	STA a:battler::id,X
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_FLY_HONEY_BELCH
	BRA @RETURN
@BATTLERNOTBELCH:
	TXA
	CLC
...
@STARTLOOP:
	CPY #BATTLER_COUNT
	BCC @NEXTBATTLER
	DISPLAY_BATTLE_TEXT_PTR TEXT_BATTLE_FLY_HONEY_NORMAL
@RETURN:
	PLD
	RTL
...
BTLACT_GIYGAS_PRAYER_2: ;$C2C5D1
	REP #PROC_FLAGS::ACCUM8 | PROC_FLAGS::INDEX8 | PROC_FLAGS::CARRY
	RESERVE_STACK_SPACE_CLOBBER 18
	LOADPTR TEXT_BATTLE_GIYGAS_PRAYER_2, $0E
	LDX #MUSIC::GIYGAS_PHASE3
	LDA #$01DF
	JSR a:.LOWORD(UNKNOWN_C2C37A)
...
BTLACT_GIYGAS_PRAYER_3: ;$C2C5FA
	REP #PROC_FLAGS::ACCUM8 | PROC_FLAGS::INDEX8 | PROC_FLAGS::CARRY
	RESERVE_STACK_SPACE_CLOBBER 18
	LOADPTR TEXT_BATTLE_GIYGAS_PRAYER_3, $0E
	LDX #MUSIC::GIYGAS_PHASE3
	LDA #$01DF
	JSR a:.LOWORD(UNKNOWN_C2C37A)
...
BTLACT_GIYGAS_PRAYER_6: ;$C2C675
	REP #PROC_FLAGS::ACCUM8 | PROC_FLAGS::INDEX8 | PROC_FLAGS::CARRY
	RESERVE_STACK_SPACE_CLOBBER 18
	LOADPTR TEXT_BATTLE_GIYGAS_PRAYER_6, $0E
	LDX #MUSIC::GIYGAS_PHASE3
	LDA #$01DF
	JSR a:.LOWORD(UNKNOWN_C2C37A)
...
BTLACT_GIYGAS_PRAYER_8: ;$C2C6D0
	REP #PROC_FLAGS::ACCUM8 | PROC_FLAGS::INDEX8 | PROC_FLAGS::CARRY
	RESERVE_STACK_SPACE_CLOBBER 18
	LOADPTR TEXT_BATTLE_GIYGAS_PRAYER_8, $0E
	LDA #$004A
