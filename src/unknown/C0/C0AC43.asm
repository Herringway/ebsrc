...
@UNKNOWN0:
	...
	CMP #$0040
	BNE @UNKNOWN2
	LDA .LOWORD(ENTITY_RIPPLE_OVERLAY_PTRS),X
	STA $02
	...
	LDX $88
	STA .LOWORD(ENTITY_RIPPLE_OVERLAY_PTRS),X
	TYA
...
@UNKNOWN1:
	...
	BRA @UNKNOWN4
@UNKNOWN2:
	LDA .LOWORD(ENTITY_BIG_RIPPLE_OVERLAY_PTRS),X
	STA $02
	...
	JSR a:.LOWORD(UNKNOWN_C0AD56)
	LDX $88
	STA .LOWORD(ENTITY_BIG_RIPPLE_OVERLAY_PTRS),X
	TYA
...
@UNKNOWN6:
	CPX #$002E
	BCC @UNKNOWN10
	LDA .LOWORD(ENTITY_SWEATING_OVERLAY_PTRS),X
	STA $02
	...
	JSR a:.LOWORD(UNKNOWN_C0AD56)
	LDX $88
	STA .LOWORD(ENTITY_SWEATING_OVERLAY_PTRS),X
	TYA
...
@UNKNOWN8:
	...
	CPX #$002E
	BCC @UNKNOWN10
	LDA .LOWORD(ENTITY_MUSHROOMIZED_OVERLAY_PTRS),X
	STA $02
	...
	JSR a:.LOWORD(UNKNOWN_C0AD56)
	LDX $88
	STA .LOWORD(ENTITY_MUSHROOMIZED_OVERLAY_PTRS),X
	TYA
