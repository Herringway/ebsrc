...
USE_SOUND_STONE: ;$C4ACCE
	...
	SEP #PROC_FLAGS::ACCUM8
	LDA #$00F0
	STA .LOWORD(UNKNOWN_7EB3EE) + 3
	STA .LOWORD(UNKNOWN_7EB3EE) + 0
	LDA #$00F8
	STA .LOWORD(UNKNOWN_7EB3F3) + 3
	STA .LOWORD(UNKNOWN_7EB3F3) + 0
	LDA #$0081
	STA .LOWORD(UNKNOWN_7EB3EE) + 4
	LDA #$0080
	STA .LOWORD(UNKNOWN_7EB3F3) + 4
	REP #PROC_FLAGS::ACCUM8
	STZ $32
	LDY #$0000
	STY $30
...
@UNKNOWN1:
	...
	OPTIMIZED_MULT $04, 14
	TAX
	STZ .LOWORD(UNKNOWN_7EB37E) + 0,X
@UNKNOWN2:
	TYA
	OPTIMIZED_MULT $04, 14
	TAX
	LDA #$0001
	STA .LOWORD(UNKNOWN_7EB37E) + 2,X
	STZ .LOWORD(UNKNOWN_7EB37E) + 6,X
	INY
	STY $30
@UNKNOWN3:
	CPY #$0008
...
@UNKNOWN21:
	...
	STA .LOWORD(UNKNOWN_7EB3EE) + 1
	LDA #$0030
	STA .LOWORD(UNKNOWN_7EB3EE) + 2
	LDX $1E
	REP #PROC_FLAGS::ACCUM8
...
@UNKNOWN23:
	...
	PLX
	CLC
	ADC .LOWORD(UNKNOWN_7EB37E) + 4,X
	STA .LOWORD(UNKNOWN_7EB3F3) + 1
	LDX $1E
	LDA f:SOUND_STONE_UNKNOWN6,X
	ASL
	CLC
	ADC #$0031
	STA .LOWORD(UNKNOWN_7EB3F3) + 2
	REP #PROC_FLAGS::ACCUM8
	LDA $20
	CLC
