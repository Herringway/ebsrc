...
TEXT_WINDOW_GFX: ;$E00000
	.INCBIN "bin/US/graphics/text_window.gfx"

FLAVOURED_TEXT_GFX: ;$E00754
	.INCBIN "bin/US/graphics/flavoured_text.gfx"
...
TOWN_MAP_ONETT: ;$E021A8
	.INCBIN "bin/US/town_maps/0.bin"

TOWN_MAP_TWOSON: ;$E04920
	.INCBIN "bin/US/town_maps/1.bin"

TOWN_MAP_THREED: ;$E06721
	.INCBIN "bin/US/town_maps/2.bin"

TOWN_MAP_FOURSIDE: ;$E08379
	.INCBIN "bin/US/town_maps/3.bin"

TOWN_MAP_SCARABA: ;$E0ADB4
	.INCBIN "bin/US/town_maps/4.bin"

TOWN_MAP_SUMMERS: ;$E0C7F1
	.INCBIN "bin/US/town_maps/5.bin"
