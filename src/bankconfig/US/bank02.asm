...
SUCCESS_LUCK80: ;$C27C96
	...
	JSR a:.LOWORD(RAND_LIMIT)
	LDX .LOWORD(CURRENT_TARGET)
	CMP a:.LOWORD(RAM)+battler::luck,X
	BCS @SUCCESS
	LDA #$0000
	BRA @RETURN
@SUCCESS:
...
@UNKNOWN5:
	...
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::SHIELD,X
	LDX .LOWORD(CURRENT_TARGET)
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::HOMESICKNESS,X
	LDX .LOWORD(CURRENT_TARGET)
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::CONCENTRATION,X
	LDX .LOWORD(CURRENT_TARGET)
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::STRANGENESS,X
	LDX .LOWORD(CURRENT_TARGET)
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::TEMPORARY,X
	LDX .LOWORD(CURRENT_TARGET)
	STA a:.LOWORD(RAM) + battler::afflictions + STATUS_GROUP::PERSISTENT_HARDHEAL,X
	REP #PROC_FLAGS::ACCUM8
	LDA .LOWORD(CURRENT_TARGET)
	CLC
	ADC #$003F
...
;A: Pointer to loaded bg data? $0E: long pointer to data to read?
UNKNOWN_C2CFE5: ;$C2CFE5
	...
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::bitdepth,Y
	LDY #bg_layer_config_entry::palette_shifting_style
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::palette_shifting_style,Y
	LDY #bg_layer_config_entry::palette_cycle_1_first
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::palette_cycle_1_first,Y
	LDY #bg_layer_config_entry::palette_cycle_1_last
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::palette_cycle_1_last,Y
	LDY #bg_layer_config_entry::palette_cycle_2_first
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::palette_cycle_2_first,Y
	LDY #bg_layer_config_entry::palette_cycle_2_last
	LDA [$06],Y
	LDY $16
	STA a:.LOWORD(RAM) + loaded_bg_data::palette_cycle_2_last,Y
...
@UNKNOWN16:
	...
	LDA #$0001
	LDX $02
	STA a:.LOWORD(RAM)+battler::id2,X
	LDX $02
	REP #PROC_FLAGS::ACCUM8
	LDA a:.LOWORD(RAM)+battler::sprite_y,X
	AND #$00FF
	ASL
	TAX
	LDA #$0001
...
@UNKNOWN21:
	...
	CMP #$0001
	BNE @UNKNOWN22
	LDA a:.LOWORD(RAM)+battler::afflictions + STATUS_GROUP::PERSISTENT_EASYHEAL,Y
	AND #$00FF
	CMP #$0001
	BEQ @UNKNOWN22
	SEP #PROC_FLAGS::ACCUM8
	LDA #$0001
	STA a:.LOWORD(RAM)+battler::id2,Y
	REP #PROC_FLAGS::ACCUM8
	LDA a:.LOWORD(RAM)+battler::sprite_y,Y
	AND #$00FF
	ASL
	TAX
	LDA #$0001
