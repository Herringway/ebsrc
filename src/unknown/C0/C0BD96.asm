...
UNKNOWN_C0BD96: ;$C0BD96
	...
	STA $28
	LDA #$0038
	STA .LOWORD(UNKNOWN_7EF200) + pathfinding::radius
	STA .LOWORD(UNKNOWN_7EF200) + pathfinding::radius + 2
	LDA .LOWORD(UNKNOWN_7EF200) + pathfinding::radius
	LSR
	STA $04
	STA .LOWORD(UNKNOWN_7E4A92)
	LDA .LOWORD(UNKNOWN_7EF200) + pathfinding::radius + 2
	LSR
	STA $02
	STA $26
	LDA $02
	...
	CMP #$0000
	BNEL @UNKNOWN1
	LDX .LOWORD(UNKNOWN_7EF200) + pathfinding::pathfinders + pathfinder::object_index
	TXA
	ASL
	STA $02
	STA $16
	...
	STX $28
	TXY
	LDA .LOWORD(UNKNOWN_7EF200) + pathfinding::pathfinders + pathfinder::origin + 2
	ASL
	ASL
	ASL
	CLC
	...
	LDA [$06]
	STA $02
	LDA .LOWORD(UNKNOWN_7EF200) + pathfinding::pathfinders + pathfinder::origin
	ASL
	ASL
	ASL
	SEC
