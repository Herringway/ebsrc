...
;unused - this difference is probably the result of an align directive of some sort, but I'm not sure how to replicate that here
.IF .DEFINED(JPN)
	.RES 302
.ELSE
	.RES 300
...
;unused - probably another alignment directive here
.IF .DEFINED(JPN)
	.RES 132
.ELSE
	.RES 42
...
.IF .DEFINED(JPN)
	BATTLE_ATTACKER_NAME:
		.RES .SIZEOF(enemy_data::name) + 4
	BATTLE_TARGET_NAME:
		.RES .SIZEOF(enemy_data::name) + 2
.ELSE
	BATTLE_ATTACKER_NAME:
		.RES .SIZEOF(enemy_data::name) + 5
	BATTLE_TARGET_NAME:
		.RES .SIZEOF(enemy_data::name) + 3
.ENDIF
CITEM:
	.RES 1
CNUM:
