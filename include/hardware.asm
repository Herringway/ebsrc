...
.ENUM CGWSEL_BITS
	MAIN_SCREEN_BLACK_NEVER = 0<<6
	MAIN_SCREEN_BLACK_NOTMATHWIN = 1<<6
	MAIN_SCREEN_BLACK_MATHWIN = 2<<6
	MAIN_SCREEN_BLACK_ALWAYS = 3<<6
	COLOUR_MATH_ENABLE_ALWAYS = 0 << 4
	COLOUR_MATH_ENABLE_MATHWIN = 1 << 4
	COLOUR_MATH_ENABLE_NOTMATHWIN = 2 << 4
	COLOUR_MATH_ENABLE_NEVER = 3 << 4
	SUBSCREEN_BGOBJ_ENABLE = 1 << 1
	SUBSCREEN_BGOBJ_DISABLE = 0 << 1
	DIRECT_COLOUR = 1
	USE_PALETTE = 0
.ENDENUM

.ENUM CGADSUB_BITS
	COLOUR_MATH_ADDSUB = 1 << 7
	COLOUR_MATH_DIV2 = 1 << 6
	COLOUR_MATH_MAINISBACKDROP = 1 << 5
	COLOUR_MATH_MAINISOBJ47 = 1 << 4
	COLOUR_MATH_MAINISBG4 = 1 << 3
	COLOUR_MATH_MAINISBG3 = 1 << 2
	COLOUR_MATH_MAINISBG2 = 1 << 1
	COLOUR_MATH_MAINISBG1 = 1 << 0
.ENDENUM
