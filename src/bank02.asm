...
MISS_CALC_UNKNOWN6:
	...
	DISPLAY_BATTLE_TEXT_PTR TEXT_BLOCK_EF76D8
	BRA MISS_CALC_UNKNOWN8
MISS_CALC_UNKNOWN7:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BLOCK_EF76C7
MISS_CALC_UNKNOWN8:
	LDA #$0001
...
BTLACT_SHOOT_UNKNOWN0:
	DISPLAY_BATTLE_TEXT_PTR TEXT_BLOCK_EF763C
...
BTLACT_POKEY_SPEECH: ;$C2C4C0
	...
	LDA #$01DC
	JSR a:.LOWORD(UNKNOWN_C2C21F)
	DISPLAY_BATTLE_TEXT_PTR TEXT_BLOCK_C8FC2E
	SEP #PROC_FLAGS::ACCUM8
